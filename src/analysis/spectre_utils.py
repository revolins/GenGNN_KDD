...
class SpectreSamplingMetrics(nn.Module):
    def __init__(self, datamodule, compute_emd, metrics_list, model=None):
        super().__init__()
...
class Comm20SamplingMetrics(SpectreSamplingMetrics):
    ...
    def __init__(self, datamodule, model=None):
        super().__init__(
            datamodule=datamodule,
            compute_emd=True,
            metrics_list=["degree", "clustering", "orbit", "spectre", "wavelet", "magnitude"],
            model=model
        )
...
class SBMSamplingMetrics(SpectreSamplingMetrics):
    def __init__(self, datamodule, model=None):
        super().__init__(
            datamodule=datamodule,
            compute_emd=False,
            metrics_list=["degree", "clustering", "orbit", "spectre", "wavelet", "sbm", "magnitude"],
            model=model
        )
